...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 36)), "/Users/jinsup/Desktop/promptbank/prompt-market-master/app/[...slug]/page.tsx"],
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6276)), "/Users/jinsup/Desktop/promptbank/prompt-market-master/app/layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4756))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["/Users/jinsup/Desktop/promptbank/prompt-market-master/app/[...slug]/page.tsx"];
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PagePage),
...
/* harmony import */ var contentlayer_generated__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6680);
/* harmony import */ var _components_mdx_components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9396);
...
async function getPageFromParams(params) {
    ...
    const page = contentlayer_generated__WEBPACK_IMPORTED_MODULE_2__/* .allPages.find */ .vI.find((page)=>page.slugAsParams === slug);
    if (!page) {
        null;
    }
    return page;
...
async function generateStaticParams() {
    return contentlayer_generated__WEBPACK_IMPORTED_MODULE_2__/* .allPages.map */ .vI.map((page)=>({
            slug: page.slugAsParams.split("/")
        }));
}
async function PagePage({ params  }) {
    const page = await getPageFromParams(params);
    if (!page) {
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("article", {
        ...
        children: [
            ...
            page.description && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                className: "text-xl",
                children: page.description
            }),
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("hr", {}),
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_mdx_components__WEBPACK_IMPORTED_MODULE_3__/* .Mdx */ .i, {
                code: page.body.code
            })
        ]
    });
...
var __webpack_exports__ = __webpack_require__.X(0, [79,198,146,823,765,314], () => (__webpack_exec__(8833)));
